...
def _configure_gpt_researcher_runtime():
    try:
        ...
        from gpt_researcher_agent.search_agent import patch_gpt_researcher_retriever
        from gpt_researcher_agent.soul_gateway import patch_gpt_researcher_llm_providers
