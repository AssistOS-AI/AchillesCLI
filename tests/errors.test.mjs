...
describe('Error Classes', () => {
    ...
    it('should load all error exports', async () => {
        errors = await import('../roboTeamAgent/copilot/src/lib/errors/index.mjs');
    ...
    describe('BaseError', () => {
        it('should create error with message', async () => {
            const { BaseError } = await import('../roboTeamAgent/copilot/src/lib/errors/BaseError.mjs');
    ...
    describe('ConfigurationError', () => {
        it('should create configuration error', async () => {
            const { ConfigurationError } = await import('../roboTeamAgent/copilot/src/lib/errors/ConfigurationError.mjs');
        ...
        it('should create repository configuration error', async () => {
            const { RepositoryConfigurationError } = await import('../roboTeamAgent/copilot/src/lib/errors/ConfigurationError.mjs');
        ...
        it('should create environment configuration error', async () => {
            const { EnvironmentConfigurationError } = await import('../roboTeamAgent/copilot/src/lib/errors/ConfigurationError.mjs');
        ...
        it('should create config file error', async () => {
            const { ConfigFileError } = await import('../roboTeamAgent/copilot/src/lib/errors/ConfigurationError.mjs');
    ...
    describe('OperationError', () => {
        it('should create git operation error', async () => {
            const { GitOperationError } = await import('../roboTeamAgent/copilot/src/lib/errors/OperationError.mjs');
        ...
        it('should create skill execution error', async () => {
            const { SkillExecutionError } = await import('../roboTeamAgent/copilot/src/lib/errors/OperationError.mjs');
        ...
        it('should create skill execution cancelled error', async () => {
            const { SkillExecutionCancelledError } = await import('../roboTeamAgent/copilot/src/lib/errors/OperationError.mjs');
        ...
        it('should create file system error', async () => {
            const { FileSystemError } = await import('../roboTeamAgent/copilot/src/lib/errors/OperationError.mjs');
    ...
    describe('ValidationError', () => {
        it('should create schema validation error', async () => {
            const { SchemaValidationError } = await import('../roboTeamAgent/copilot/src/lib/errors/ValidationError.mjs');
        ...
        it('should create field validation error', async () => {
            const { FieldValidationError } = await import('../roboTeamAgent/copilot/src/lib/errors/ValidationError.mjs');
        ...
        it('should create required field error', async () => {
            const { RequiredFieldError } = await import('../roboTeamAgent/copilot/src/lib/errors/ValidationError.mjs');
    ...
    describe('ResourceError', () => {
        it('should create skill not found error with suggestions', async () => {
            const { SkillNotFoundError } = await import('../roboTeamAgent/copilot/src/lib/errors/ResourceError.mjs');
        ...
        it('should create repository not found error', async () => {
            const { RepositoryNotFoundError } = await import('../roboTeamAgent/copilot/src/lib/errors/ResourceError.mjs');
        ...
        it('should create directory not found error', async () => {
            const { DirectoryNotFoundError } = await import('../roboTeamAgent/copilot/src/lib/errors/ResourceError.mjs');
