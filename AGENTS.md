...
1. Read `README.md` and `docs/index.html` for the user and system overview.
2. Read `docs/wiki.html` for canonical project terminology.
3. Read `docs/specs/matrix.md`, the relevant DS files, and `docs/specs/DS001-coding-style.md` for coding style, source layout, and test organization.
...
Update this section, `docs/index.html`, `docs/skills.html`, `docs/wiki.html`, and the relevant specifications whenever the distributed product skill catalog changes. Internal documentation-authoring tools are not product skills and must not appear in persistent project documentation.
...
- Keep DS numbering contiguous. Exactly one `docs/specs/DS003-main-behavior.md` records the defining product behaviors.
...
- Preserve the documentation structure, canonical wiki links, submenu navigation, unwrapped source prose, and declarative DS contracts established under `docs/`.
...
- `docs/usage.html` — installation, configuration, and command workflows.
- `docs/architecture.html` — runtime and security boundaries.
- `docs/skills.html` — distributed built-in skill catalog.
- `docs/wiki.html` — canonical terminology.
- `docs/specs/` — authoritative design specifications.
- `docs/specs/DS001-coding-style.md` — coding and test conventions.
